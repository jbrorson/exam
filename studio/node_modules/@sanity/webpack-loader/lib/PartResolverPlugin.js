...
const isSanityPart = request => partMatcher.test(request.request) || configMatcher.test(request.request);
  ...
  compiler.resolvers.normal.plugin('module', function (request, callback) {
    ...
    if (configMatch) {
      ...
      const req = Object.assign({}, request, {
        request: configFor === 'sanity' ? path.join(basePath, 'sanity.json') : path.join(configPath, `${configMatch[1]}.json`)
      });
