...
exports.default = function (config) {
  ...
  return Object.assign({}, baseConfig, {
    ...
    plugins: (baseConfig.plugins || []).concat([new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.NoErrorsPlugin()]),
    module: Object.assign({}, baseConfig.module, {
      loaders: (0, _applyStaticLoaderFix2.default)(baseConfig, config)
    })
  });
};